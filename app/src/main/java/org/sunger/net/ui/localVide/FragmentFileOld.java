...
import org.sunger.net.service.MediaScannerService.IMediaScannerObserver;
import org.sunger.net.service.MediaScannerService.MediaScannerServiceBinder;
...
public class FragmentFileOld extends FragmentBase implements OnItemClickListener, IMediaScannerObserver {
	...
	private LocalVideoActivity mParent;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		// ~~~~~~~~~ 加载数据
		mParent = (LocalVideoActivity) getActivity();
