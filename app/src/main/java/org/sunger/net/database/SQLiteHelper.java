...
public class SQLiteHelper extends SQLiteOpenHelper {
	...
	private final static String SQL_CREATE_FILES = "CREATE TABLE \"files\" (" + //FilesColumns.COL_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + //
	    TableColumns.FilesColumns.COL_TITLE + " TEXT," + //
	    TableColumns.FilesColumns.COL_TITLE_PINYIN + " TEXT," + //
	    TableColumns.FilesColumns.COL_PATH + " TEXT," + //
	    TableColumns.FilesColumns.COL_DURATION + " INTEGER," + //
	    TableColumns.FilesColumns.COL_POSITION + " TEXT," + //
	    TableColumns.FilesColumns.COL_LAST_ACCESS_TIME + " INTEGER," + //
	    TableColumns.FilesColumns.COL_THUMB + " TEXT," + //
	    TableColumns.FilesColumns.COL_FILE_SIZE + " INTEGER" + //
	    ")";
